...
class GL {
    ...
    {
        //TODO lime_gl_bind_attrib_location(program.id, index, name);
    }
    ...
    {
        //TODO lime_gl_compressed_tex_image_2d(target, level, internalformat, width, height, border, data == null ? null : data.getByteBuffer(), data == null ? null : data.getStart());
    }
    ...
    {
        //TODO lime_gl_compressed_tex_sub_image_2d(target, level, xoffset, yoffset, width, height, format, data == null ? null : data.getByteBuffer(), data == null ? null : data.getStart());
    }
    ...
    {
        //TODO lime_gl_copy_tex_image_2d(target, level, internalformat, x, y, width, height, border);
    }
    ...
    {
        //TODO lime_gl_copy_tex_sub_image_2d(target, level, xoffset, yoffset, x, y, width, height);
    }

    public static function createBuffer():GLBuffer 
    {
        //TODO return new GLBuffer(version, lime_gl_create_buffer());
        return null;
    }

    public static function createFramebuffer():GLFramebuffer 
    {
        //TODO return new GLFramebuffer(version, lime_gl_create_framebuffer());
        return null;
    }

    public static function createProgram():GLProgram 
    {
        //TODO return new GLProgram(version, lime_gl_create_program());
        return null;
    }

    public static function createRenderbuffer():GLRenderbuffer 
    {
        //TODO return new GLRenderbuffer(version, lime_gl_create_render_buffer());
        return null;
    }

    public static function createShader(type:Int):GLShader 
    {
        //TODO return new GLShader(version, lime_gl_create_shader(type));
        return null;
    }

    public static function createTexture():GLTexture 
    {
        //TODO return new GLTexture(version, lime_gl_create_texture());
        return null;
    }
    ...
    {
        //TODO lime_gl_delete_buffer(buffer.id);
        //buffer.invalidate();
    }
    ...
    {
        //TODO lime_gl_delete_program(program.id);
        //program.invalidate();
    }
    ...
    {
        //TODO return lime_gl_is_enabled(cap);
        return false;
    }

    public static function isFramebuffer(framebuffer:GLFramebuffer):Bool 
    {
        //TODO return framebuffer != null && framebuffer.id > 0 && lime_gl_is_framebuffer(framebuffer.id);
        return false;
    }

    public static function isProgram(program:GLProgram):Bool 
    {
        //TODO return program != null && program.id > 0 && lime_gl_is_program(program.id);
        return false;
    }

    public static function isRenderbuffer(renderbuffer:GLRenderbuffer):Bool 
    {
        //TODO return renderbuffer != null && renderbuffer.id > 0 && lime_gl_is_renderbuffer(renderbuffer.id);
        return false;
    }

    public static function isShader(shader:GLShader):Bool 
    {
        //TODO return shader != null && shader.id > 0 && lime_gl_is_shader(shader.id);
        return false;
    }

    public static function isTexture(texture:GLTexture):Bool 
    {
        //TODO return texture != null && texture.id > 0 && lime_gl_is_texture(texture.id);
        return false;
    }

    public static function lineWidth(width:Float):Void 
    {
        //TODO lime_gl_line_width(width);
    }

    public static function linkProgram(program:GLProgram):Void 
    {
        //TODO lime_gl_link_program(program.id);
    }
...
//
 //       } catch(e:Dynamic) 
   //     {
    ...
    {
        //TODO lime_gl_pixel_storei(pname, param);
    }

    public static function polygonOffset(factor:Float, units:Float):Void 
    {
        //TODO lime_gl_polygon_offset(factor, units);
    }
    ...
    {
        //TODO lime_gl_tex_image_2d(target, level, internalformat, width, height, border, format, type, pixels == null ? null : pixels.getByteBuffer(), pixels == null ? null : pixels.getStart());
    }

    public static function texParameterf(target:Int, pname:Int, param:Float):Void 
    {
        //TODO lime_gl_tex_parameterf(target, pname, param);
    }

    public static function texParameteri(target:Int, pname:Int, param:Int):Void 
    {
        //TODO lime_gl_tex_parameteri(target, pname, param);
    }
